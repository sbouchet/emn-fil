...
public final class ProtocoleChat
{
	...
	/**
	 * Commande de sortie du chat.
	 * 
	 * TODO : Enlever cette commande dans la version étudiant.
	 */
	public static final char COMMANDE_SORTIE_CHAT = 'q';
	...
	public static final String MESSAGE_AIDE = "* Commandes disponibles : %n"
			...
			// TODO : enlever cette information dans la version étudiant. 
			+ ProtocoleChat.ESPACE_MESSAGE_AIDE + ProtocoleChat.COMMANDE_CARACTERE
			+ ProtocoleChat.COMMANDE_SORTIE_CHAT + " : sortir du chat.%n";

	/**
	 * Message de sortie d'un client du chat.
	 * 
	 * TODO : Enlever ce message dans la version étudiant.
	 */
	public static final String MESSAGE_SORTIE_CLIENT = "* Sortie du chat.%n";
