...
public final class ServiceChat
{
	 ...
	 *
	 * TODO : ajouter paramètre Integer port dans la version étudiant (pour lancement du service).
	 * TODO : throws IOException dans la version étudiant.
	 * 
	 */
	public ServiceChat(String canal)
	{
		...
		// TODO : appel de la méthode lanceService dans la version étudiant.
	}
	 ...
	 * 
	 * TODO : méthode private dans la version étudiant.
	 *
	 */
	...
	/** 
	 * Sortir un client du chat.
	 * 
	 * @param client le client à sortir du chat.
	 * 
	 * TODO : enlever cette méthode dans la version étudiant.
	 */
	public void sortClientChat(ClientChat client)
	{
		final String message = String.format(ProtocoleChat.MESSAGE_SORTIE_CLIENT);
